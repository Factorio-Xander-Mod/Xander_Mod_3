...
local xm_material_subgroups = {"raw-material", "raw-resource", "milled-resource", "concentrate", "oxide", "ingot", "billet", "stock", "nonmetal", "terrain", "ceramic", "salt", "fluid-recipes", "organic", "polymer", "energetic"}--, "binary-fluid-recipes", "hydrocarbon-fluid-recipes"
local xm_fluid_subgroups = {"fluid-element", "fluid-hydrogenated", "fluid-oxide", "fluid-halogenated", "fluid", "fluid-hydrocarbon", "fluid-organic"}
local xm_intermediate_products_subgroups = {"mechanical", "electrical", "data", "optical", "intermediate-product", "science-pack", "combat-part", "fill-barrel", "empty-barrel"}
