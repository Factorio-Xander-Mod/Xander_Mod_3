...
xm_material_recipes["ingot"] = {
	...
	{"uranium-238", "chemistry-2", 5, false, {{type = "fluid", name = "uranium-depleted-hexafluoride", amount = 10}, {type = "fluid", name = "hydrogen", amount = 20}, {"aluminum", 1}}, {{"uranium-238", 1}, {type = "fluid", name = "hydrogen-fluoride", amount = 50}}},--1
	{"uranium-235", "chemistry-2", 5, false, {{type = "fluid", name = "uranium-weapons-hexafluoride", amount = 10}, {type = "fluid", name = "hydrogen", amount = 20}, {"aluminum", 1}}, {{"uranium-235", 1}, {type = "fluid", name = "hydrogen-fluoride", amount = 50}}},--1
}
...
xm_material_recipes["stock"] = {
	...
	{"steel-plate-1", "smelting-2", 24, false, {{"raw-iron", 18}, {"clay", 1}}, {{"steel-plate", 6}}},--3
	{"steel-plate-2", "smelting-3", 18, false, {{"raw-iron", 12}, {"limestone", 1}, {type = "fluid", name = "oxygen", amount = 12}}, {{"steel-plate", 6}}},--2
...
xm_material_recipes["nonmetal"] = {
	...
	{"silicon-boule", "smelting-3", 144, false, {{"silicon", 23}, {"phosphorus", 1}, {type = "fluid", name = "chlorine", amount = 24}}, {{"silicon-boule", 2}}},--12
...
xm_material_recipes["terrain"] = {
	...
	{"cliff-explosives", "crafting", 8, false, {{"empty-barrel", 1}, {"gunpowder", 20}, {"grenade", 1}}, {{"cliff-explosives", 1}}},--40
	{"cliff-explosives-1", "crafting", 8, false, {{"empty-barrel", 1}, {"explosives", 10}, {"grenade", 1}}, {{"cliff-explosives", 1}}},--30
}
...
xm_material_recipes["energetic"] = {
	...
	{"explosives", "chemistry", 2, false, {{"nitrated-organics", 1}, {type = "fluid", name = "nitric-acid", amount = 10}, {type = "fluid", name = "water-distilled", amount = 10}}, {{"explosives", 1}}},-- ~ 1
}
...
xm_fluids_recipes["fluid"] = {
	...
	{"uranium-natural-hexafluoride", "chemistry-2", 4, false, {{"uranium-ore", 12}, {type = "fluid", name = "hydrogen-fluoride", amount = 60}}, {{type = "fluid", name = "uranium-natural-hexafluoride", amount = 10}}},--1
	{"uranium-processing", "centrifuging", 120, false, {{type = "fluid", name = "uranium-natural-hexafluoride", amount = 100}}, {{type = "fluid", name = "uranium-fuel-hexafluoride", amount = 14}, {type = "fluid", name = "uranium-depleted-hexafluoride", amount = 86}}},--1
	{"uranium-weapons-enrichment", "centrifuging", 10, false, {{type = "fluid", name = "uranium-fuel-hexafluoride", amount = 19}}, {{type = "fluid", name = "uranium-weapons-hexafluoride", amount = 1}, {type = "fluid", name = "uranium-depleted-hexafluoride", amount = 18}}},--1
}
...
xm_fluids_recipes["fluid-hydrocarbon"] = {
	...
	{"advanced-oil-processing", "oil-processing", 8, false, {{type = "fluid", name = "crude-oil-desulf", amount = 100}, {type = "fluid", name = "water-distilled", amount = 50}}, {{type = "fluid", name = "heavy-oil", amount = 40, fluidbox_index = 1}, {type = "fluid", name = "light-oil", amount = 50, fluidbox_index = 2}, {type = "fluid", name = "petroleum-gas", amount = 10, fluidbox_index = 3}}},
...
xm_intermediate_products_recipes["electrical"] = {
	...
	{"coil-3", "crafting-with-fluid", 3, false, {{"steel-rod", 4}, {"copper-cable", 8}, {"wafer-0", 1}, {type = "fluid", name = "uncured-epoxy", amount = 10}}, {{"coil-3", 2}}},--4
	{"wire-solder-0", "machine-0", 3, false, {{"solder", 3}, {"resin", 1}}, {{"wire-solder", 6}}},--0.5(1/24)
	{"wire-solder-1", "machine-1", 3, false, {{"solder", 3}, {"phenol", 1}}, {{"wire-solder", 8}}},--0.5
	{"wire-gold", "machine-1", 0.5, false, {{"gold", 1}}, {{"wire-gold", 2}}},--0.5
...
xm_intermediate_products_recipes["data"] = {
	...
	{"wafer-data-1", "crafting-with-fluid", 6, false, {{"wafer-0", 2}, {"tungsten", 1}, {"sodium-hydroxide", 1}, {type = "fluid", name = "nitric-acid", amount = 10}}, {{"wafer-data-1", 2}}},--1.5
	{"wafer-data-2", "chemistry-2", 5, false, {{"wafer-data-1", 2}, {"silicon", 1}, {"aluminum", 1}, {type = "fluid", name = "carbon-monoxide", amount = 8}, {type = "fluid", name = "hydrogen-fluoride", amount = 12}}, {{"wafer-data-2", 1}}},--6
...
xm_intermediate_products_recipes["intermediate-product"] = {
	{"empty-barrel", "crafting", 1, false, {{"steel-plate", 2}}, {{"empty-barrel", 1}}},--4
...
xm_intermediate_products_recipes["nuclear"] = {
	{"uranium-fuel-pellet", "centrifuging", 2.5, false, {{type = "fluid", name = "uranium-fuel-hexafluoride", amount = 10}, {type = "fluid", name = "hydrogen", amount = 20}}, {{"uranium-fuel-pellet", 1}, {type = "fluid", name = "hydrogen-fluoride", amount = 50}}},--1
	{"uranium-fuel-cell", "advanced-crafting", 10, false, {{"uranium-fuel-pellet", 4}, {"graphite", 2}, {"stock-zircalloy", 1}}, {{"uranium-fuel-cell", 2}}},--4
	{"kovarex-fuel-cell", "advanced-crafting", 24, false, {{"uranium-238", 10}, {"uranium-235", 50}, {"graphite", 10}, {"stock-zircalloy", 5}}, {{"kovarex-fuel-cell", 1}}},--80
	{"nuclear-fuel-reprocessing", "centrifuging", 6, false, {{"used-up-uranium-fuel-cell", 1}, {type = "fluid", name = "hydrogen-fluoride", amount = 60}}, {{type = "fluid", name = "uranium-depleted-hexafluoride", amount = 10}}},--1
	{"kovarex-enrichment-process", "centrifuging", 36, false, {{"enriched-kovarex-fuel-cell", 1}, {type = "fluid", name = "hydrogen-fluoride", amount = 600}}, {{"uranium-235", 50}, {type = "fluid", name = "uranium-fuel-hexafluoride", amount = 100}}},--1
	{"nuclear-fuel", "centrifuging", 90, false, {{type = "fluid", name = "uranium-weapons-hexafluoride", amount = 10}, {"rocket-fuel", 1}}, {{"nuclear-fuel", 1}}},--25
}
...
xm_production_recipes["energy"] = {
	...
	{"heat-exchanger", "crafting", 12, false, {{"pipe", 20}, {"stock-cupronickel", 30}, {"stock-stainless", 40}, {"fiber-glass", 60}}, {{"heat-exchanger", 1}}},--160
	...
	{"steam-turbine-1", "crafting", 12, false, {{"stock-stainless", 32}, {"pipe", 16}, {"parts-alloy", 8}, {"motor-3", 4}}, {{"steam-turbine-1", 1}}},--144
	{"heat-pipe", "crafting", 6, false, {{"stock-cupronickel", 25}, {"stock-stainless", 10}, {"fiber-glass", 30}}, {{"heat-pipe", 1}}},--60
	{"nuclear-reactor", "crafting", 24, false, {{"stock-stainless", 500}, {"stock-zircalloy", 500}, {"concrete", 500}, {"parts-alloy", 500}, {"advanced-circuit", 400}}, {{"nuclear-reactor", 1}}},--8500
...
xm_production_recipes["module"] = {
	{"beacon", "crafting", 15, false, {{"stock-stainless", 40}, {"parts-alloy", 15}, {"coil-3", 15}, {"advanced-circuit", 16}}, {{"beacon", 1}}},--360
	{"speed-module", "crafting", 15, false, {{"motor-2", 6}, {"electronic-circuit", 5}}, {{"speed-module", 1}}},--56 (base = 62.5)
	{"speed-module-2", "crafting", 30, false, {{"speed-module", 4}, {"stock-duralumin", 48}, {"advanced-circuit", 28}}, {{"speed-module-2", 1}}},--600 (base = 652.5)
	{"speed-module-3", "advanced-crafting", 60, false, {{"speed-module-2", 5}, {"plastic-bar", 40}, {"motor-3", 6}, {"processing-unit", 8}}, {{"speed-module-3", 1}}},--3600 (base = 3665)
	{"productivity-module", "crafting", 15, false, {{"fast-transport-belt", 4}, {"electronic-circuit", 6}}, {{"productivity-module", 1}}},--56 (base = 62.5)
	{"productivity-module-2", "crafting", 30, false, {{"productivity-module", 4}, {"filter-inserter", 4}, {"advanced-circuit", 28}}, {{"productivity-module-2", 1}}},--600 (base = 652.5)
	{"productivity-module-3", "advanced-crafting", 60, false, {{"productivity-module-2", 5}, {"stack-filter-inserter", 1}, {"processing-unit", 8}}, {{"productivity-module-3", 1}}},--3600 (base = 3665)
	{"effectivity-module", "crafting", 15, false, {{"fiber-glass", 48}, {"electronic-circuit", 8}}, {{"effectivity-module", 1}}},--56 (base = 62.5)
	{"effectivity-module-2", "crafting", 30, false, {{"effectivity-module", 4}, {"parts-alloy", 34}, {"advanced-circuit", 24}}, {{"effectivity-module-2", 1}}},--600 (base = 652.5)
	{"effectivity-module-3", "advanced-crafting", 60, false, {{"effectivity-module-2", 5}, {"battery", 22}, {"processing-unit", 8}}, {{"effectivity-module-3", 1}}},--3600 (base = 3665)
}
...
xm_logistics_recipes["inserter"] = {
	...
	{"stack-filter-inserter", "crafting", 0.5, false, {{"stack-inserter", 1}, {"electronic-circuit", 1}}, {{"stack-filter-inserter", 1}}},--88
}
...
xm_combat_recipes["gun"] = {
	...
	{"land-mine", "crafting", 5, false, {{"steel-plate", 2}, {"explosives", 4}}, {{"land-mine", 4}}},--2 (8 per recipe)
}
...
xm_combat_recipes["capsule"] = {
	{"grenade", "crafting", 8, false, {{"stock-cast-iron", 8}, {"gunpowder", 12}}, {{"grenade", 1}}},--20
	{"grenade-1", "crafting", 8, false, {{"stock-cast-iron", 8}, {"explosives", 8}}, {{"grenade", 1}}},--16
...
xm_combat_recipes["armor"] = {
	...
	{"power-armor", "crafting", 30, false, {{"stock-duralumin", 250}, {"plastic-bar", 300}, {"parts-alloy", 180}, {"motor-3", 100}, {"processing-unit", 20}}, {{"power-armor", 1}}},--3600
	{"power-armor-mk2", "crafting", 30, false, {{"stock-stainless", 600}, {"low-density-structure", 100}, {"speed-module-2", 24}, {"effectivity-module-2", 24}, {"processing-unit", 100}}, {{"power-armor-mk2", 1}}},--40000
}

xm_combat_recipes["equipment"] = {
	{"solar-panel-equipment", "crafting", 10, false, {{"solar-panel", 1}, {"advanced-circuit", 6}, {"electronic-circuit", 9}}, {{"solar-panel-equipment", 2}}},--120
	{"fusion-reactor-equipment", "crafting", 40, false, {{"energy-shield-mk2-equipment", 5}, {"effectivity-module-2", 10}, {"processing-unit", 12}, {"low-density-structure", 30}, {"stock-zircalloy", 200}}, {{"fusion-reactor-equipment", 1}}},--20248
	{"battery-equipment", "crafting", 10, false, {{"advanced-circuit", 2}, {"battery", 10}, {"parts-steel", 10}}, {{"battery-equipment", 1}}},--70
	{"battery-mk2-equipment", "crafting", 20, false, {{"battery-equipment", 10}, {"low-density-structure", 15}, {"processing-unit", 10}}, {{"battery-mk2-equipment", 1}}},--1880
	{"belt-immunity-equipment", "crafting", 10, false, {{"expedited-transport-belt", 2}, {"advanced-circuit", 4}, {"parts-alloy", 6}}, {{"belt-immunity-equipment", 1}}},--100
	{"exoskeleton-equipment", "crafting", 10, false, {{"motor-3", 20}, {"processing-unit", 10}, {"parts-alloy", 50}, {"stock-duralumin", 100}}, {{"exoskeleton-equipment", 1}}},--1200
	{"personal-roboport-equipment", "crafting", 4, false, {{"roboport", 1}, {"battery", 40}}, {{"personal-roboport-equipment", 2}}},--480
	{"personal-roboport-mk2-equipment", "crafting", 20, false, {{"personal-roboport-equipment", 5}, {"low-density-structure", 30}, {"processing-unit", 100}}, {{"personal-roboport-mk2-equipment", 1}}},--9880
	{"night-vision-equipment", "crafting", 10, false, {{"advanced-circuit", 5}, {"glass", 20}, {"plastic-bar", 30}}, {{"night-vision-equipment", 1}}},--100
	
	{"energy-shield-equipment", "crafting", 10, false, {{"coil-2", 18}, {"advanced-circuit", 3}, {"tungsten", 36}}, {{"energy-shield-equipment", 1}}},--120
	{"energy-shield-mk2-equipment", "crafting", 20, false, {{"energy-shield-equipment", 10}, {"coil-3", 70}, {"processing-unit", 10}}, {{"energy-shield-mk2-equipment", 1}}},--2400
	{"personal-laser-defense-equipment", "crafting", 10, false, {{"laser-turret", 5}, {"low-density-structure", 20}, {"processing-unit", 20}}, {{"personal-laser-defense-equipment", 1}}},--2980
	{"discharge-defense-equipment", "crafting", 10, false, {{"laser-turret", 10}, {"stock-duralumin", 28}, {"processing-unit", 6}}, {{"discharge-defense-equipment", 1}}},--2400
	{"discharge-defense-remote", "crafting", 1, false, {{"advanced-circuit", 1}}, {{"discharge-defense-remote", 1}}},--10
}
