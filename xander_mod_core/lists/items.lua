...
xm_material_items["concentrate"] = {"conc-millerite", "clay", "kaolin", "conc-bauxite", "conc-fluorite", "sand", "conc-scheelite", "gravel", "limestone", "magnesite"}
xm_material_items["oxide"] = {"sodium-hydroxide", "aluminum-hydroxide", "tungsten-oxide"}
xm_material_items["ingot"] = {"aluminum", "nickel", "tin", "tungsten", "lead", "solder"}--, "gold"
...
--xm_production_items["tool"] = {"repair-pack"} --Types other than "item"
...
xm_production_items["extraction-machine"] = {"offshore-pump", "burner-mining-drill", "electric-mining-drill", "pumpjack", "ore-processor-0", "ore-processor-1", "ore-processor-2"}
...
xm_production_items["chemical-machine"] = {"chemical-plant", "electrolyzer-1", "oil-refinery", "centrifuge"}
