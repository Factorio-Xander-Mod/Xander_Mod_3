...
data.raw.recipe["phosphorus"].localised_name = {"recipe-name.sulfur-1"}
data.raw.recipe["phosphorus"].icon = "__xander-mod__/graphics/recipe/material/nonmetal/phosphorus.png"
